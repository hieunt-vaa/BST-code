...
|-|-|-|-|-|
|`scaled_output_159bits_PCR.csv`|PCR (P_C2R)|`P_C2R_1, PC2R_2, P_C2R_3`|8000|166|
...
|-|-|-|
|`scaler_x_input_min_PCR.save`|PCR|Inverse-transform of input X (min-max)|
|`scaler_y_output_min_PCR.save`|PCR|Inverse-transform of output `z_1..z_3`|
...
|-|-|-|-|-|-|
|`Main_PC2R.py`|`scaled_output_159bits_PCR.csv`|`scaler_x_input_min_PCR.save`|`scaler_y_output_min_PCR.save`|3|`multitask_159bits_3real_PCR.pth`|
...
df = pd.read_csv("Data/scaled_output_159bits_PCR.csv")
