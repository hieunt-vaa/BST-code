...
# 0) Config
# =========================
CSV_PATH = "scaled_output_159bits_Kx.csv"
SCALER_X_PATH = "scaler_x_input_min_Kx.save"           # scaler X (min-max?) để inverse_transform
SCALER_Y_PATH = "scaler_y_output_min_PKx.save"     # scaler Y (standard) để inverse_transform
SAVE_MODEL_PATH = "multitask_159bits_3real_Kx.pth"
...
class MultiTaskNet(nn.Module):
    def __init__(self, input_dim=2, hidden_dim=256, bit_dim=159, real_dim=3):
        super().__init__()
...
model = MultiTaskNet(input_dim=2, hidden_dim=HIDDEN, bit_dim=159, real_dim=3).to(DEVICE)
