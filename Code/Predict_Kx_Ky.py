...
MODEL_PATH = "multitask_159bits_3real_Kx_.pth"
SCALER_X_PATH = "scaler_x_input_min_Kx.save"
SCALER_Y_PATH = "scaler_y_output_min_PKx.save"
OUTPUT_CSV = "prediction_results_Kx.csv"
INPUT_COLS = ['Kx','Ky']
